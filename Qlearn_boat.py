...
def get_reward(state_n, act):
    ...
    if act == motor_stop:
        ...
        action_reward = -abs(act - motor_stop)
    reward = xvel_reward + heading_reward
    return reward, xvel_reward, heading_reward

def export_data(episode, time_now, xvel_data, heading_data, omega_data, action_taken, velocity_reward, heading_reward, omega_reward, action_reward, track_reward):
